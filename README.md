...
本仓库通过 GitHub Actions 自动构建便携式 mpv 播放器整合包。

**构建内容：**
- **mpv** — 来自 [dyphire/mpv-winbuild](https://github.com/dyphire/mpv-winbuild) 的最新构建
- **FFmpeg** — 来自同一构建源的 ffmpeg/ffprobe
- **yt-dlp** — 最新的 yt-dlp.exe
...
构建完成后在 [Releases](https://github.com/xymhh/mpv-config-bundle/releases) 页面下载 `.zip` 包，解压即用。
